...
import com.sksanwar.cricketbangla.Pojo.LiveMatchDetailsPojo.Apis;
import com.sksanwar.cricketbangla.Pojo.LiveMatchDetailsPojo.Official;
...
public class RecentMatchDetails implements Parcelable {
    @SuppressWarnings("unused")
    public static final Creator<RecentMatchDetails> CREATOR = new Creator<RecentMatchDetails>() {
        @Override
        public RecentMatchDetails createFromParcel(Parcel in) {
            return new RecentMatchDetails(in);
        }

        @Override
        public RecentMatchDetails[] newArray(int size) {
            return new RecentMatchDetails[size];
        }
    };
    ...
    public RecentMatchDetails(Official official, ArrayList<Object> audio, String alerts, Team team1, Team team2,
    ...
    protected RecentMatchDetails(Parcel in) {
