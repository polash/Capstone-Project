...
import com.sksanwar.cricketbangla.UI.LiveMatchDetailsFragment;

/**
 * Created by sksho on 26-Nov-17.
 */

public class LiveMatchDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            LiveMatchDetailsFragment detailActivityFragment = new LiveMatchDetailsFragment();
